# Name: palindromes.py
palindromes.py - Program that generates (a stream of) multi-word palindromes in a given language.

# Description:
palindromes.py is a Python3 program that generates multi-word palindromes in a given language,
